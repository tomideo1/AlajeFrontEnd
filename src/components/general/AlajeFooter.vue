<template>
  <div>
    <div class="mt-5 position-relative bg-white  ">
      <div class="container">
        <div class="row">
      ...
      <div class="container">
        <div class="row">
          <p class="font-avenir mt-2  col-10 col-lg-10 col-md-10 text-black ft-12">&copy; 2020 Alaje Hub All Rights Reserved</p>
